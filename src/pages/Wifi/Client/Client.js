...
function Client() {
    ...
    const loadClients = async()=>{
        const all = await axios.get('http://localhost:2022/client/all')
        setClients(all.data)
    ...
    const editClient = async(e) => {
      console.log(e.target.value)
      const id = e.target.value
      const clientEdit = await axios.get('http://localhost:2022/client/get?id='+id)
      console.log('in edit')
    ...
    const updatePhone = async(e) => {
      ...
      console.log(client)
      await axios.post('http://localhost:2022/client/update', client)
      loadClients()
