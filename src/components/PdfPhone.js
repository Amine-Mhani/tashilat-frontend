    ...
    <img class="img-responsive" alt="iamgurdeeposahan" src="../assets/img/elements/tashilat.jpg" style={{width: "300px",borderRadius:"75px"}} />
            ...
            <div class="col-md-4 text-left">
					{/* <div class="col-xs-6 col-sm-6 col-md-6 text-left"> */}
						<div>
							<h5>Client.</h5>
							<p>{props.phone.number} <i class="fa fa-phone"></i></p>
							<p>{props.phone.email} <i class="fa fa-envelope-o"></i></p>
						</div>
					{/* </div> */}
            </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="col-md-3"><i class="fa fa-inr"></i> Phone minutes</td>
                        </tr>
                        <tr>
                            <td class="col-md-9">Operator</td>
                            <td class="col-md-3"><i class="fa fa-inr"></i> {props.phone.operator.name}</td>
                        </tr>
                        <tr>
                            <td class="col-md-9">Price</td>
                            <td class="col-md-3"><i class="fa fa-inr"></i> {props.phone.price} DH</td>
                        </tr>
                        <tr>
                           
                            <td class="text-right"><h2><strong>Total: </strong></h2></td>
                            <td class="text-left text-primary"><h2><strong><i class="fa fa-inr"></i> {props.phone.price} DH</strong></h2></td>
                        </tr>
                    </tbody>
                </table>
            </div>
