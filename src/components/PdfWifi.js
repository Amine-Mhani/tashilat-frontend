    ...
    <img class="img-responsive" alt="iamgurdeeposahan" src="../assets/img/elements/tashilat.jpg" style={{width: "300px",borderRadius:"75px"}} />
            ...
            <div class="col-md-4 text-left">
					{/* <div class="col-xs-6 col-sm-6 col-md-6 text-left"> */}
						<div>
							<h5>Client.</h5>
                            <p>Mr. {props.wifi.client.lname+""+props.wifi.client.fname} <i class="fa fa-location-arrow"></i></p>
							<p>{props.wifi.client.number} <i class="fa fa-phone"></i></p>
							<p>{props.wifi.client.email} <i class="fa fa-envelope-o"></i></p>
						</div>
					{/* </div> */}
            </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                     <tr>
                            ...
                            <td class="col-md-3"><i class="fa fa-inr"></i> Wifi</td>
                        </tr>
                        <tr>
                            <td class="col-md-9">Operator</td>
                            <td class="col-md-3"><i class="fa fa-inr"></i> {props.wifi.operator.name}</td>
                        </tr>
                        <tr>
                            <td class="col-md-9">Month</td>
                            <td class="col-md-3"><i class="fa fa-inr"></i> {toMonthName(props.wifi.month)}</td>
                        </tr>
                        <tr>
                            <td class="col-md-9">Price</td>
                            <td class="col-md-3"><i class="fa fa-inr"></i> {props.wifi.price} DH</td>
                        </tr>
                        <tr>
                           
                            <td class="text-right"><h2><strong>Total: </strong></h2></td>
                            <td class="text-left text-primary"><h2><strong><i class="fa fa-inr"></i> {props.wifi.price} DH</strong></h2></td>
                        </tr>
                    </tbody>
                </table>
            </div>
